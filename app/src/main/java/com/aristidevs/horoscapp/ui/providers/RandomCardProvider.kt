...
class RandomCardProvider @Inject constructor() {
    fun getLucky(): LuckyModel? {
        /*el when exige siempre contemplar un else, no sabe que tenemos un rango controlado,
         y si el else que ponemos en null el valor de retorno (LuckyModel) debe ser nullable LuckyModel?*/
